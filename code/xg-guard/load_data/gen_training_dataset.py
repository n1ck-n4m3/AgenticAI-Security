...
if __name__ == "__main__":
    ...
    if args.type == "super":
        data_dir = "./datasets_online/MA/agent_graph_dataset/{}/train1/dataset.json".format(meta_dataset)
    elif args.type == "unsuper":
        data_dir = "./datasets_online/MA/agent_graph_dataset/{}/train/dataset.json".format(meta_dataset)
    elif args.type == "test":
        data_dir = "./datasets_online/MA/agent_graph_dataset/{}/test/dataset.json".format(meta_dataset)
