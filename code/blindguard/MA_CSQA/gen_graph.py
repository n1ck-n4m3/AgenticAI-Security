...
if __name__ == "__main__":
    ...
    def parse_arguments():
        ...
        parser.add_argument("--dataset_path", type=str, default="./datasets", help="The path to store the dataset")
        ...
        if args.phase == "train":
            args.dataset_path = os.path.join(args.dataset_path, "CSQA_train_MA.json")
        elif args.phase == "test": 
            args.dataset_path = os.path.join(args.dataset_path, "CSQA_test_MA.json")
        else: 
