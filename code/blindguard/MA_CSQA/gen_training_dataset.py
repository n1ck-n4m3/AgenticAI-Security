...
if __name__ == "__main__":
    ...
    if args.type == "super":
        data_dir = "./agent_graph_dataset/{}/train1/dataset.json".format(meta_dataset)
    elif args.type == "test":
        data_dir = "./agent_graph_dataset/{}/test/dataset.json".format(meta_dataset)
    ...
    embedding_model_dir = "/home/miaorui/project/Code/LLM/sentence-transformers/all-MiniLM-L6-v2"
